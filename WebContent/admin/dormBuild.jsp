			...
			<table class="table table-striped table-bordered table-hover datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='querydorm?dormBuildId=${dormBuild.dormBuildId}&dormBuildName=${dormBuild.dormBuildName}'">查看该栋宿舍</button>&nbsp; 
