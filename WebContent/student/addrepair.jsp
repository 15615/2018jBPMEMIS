...
<div class="data_list">
		...
		<form action="addsturepair" method="post" onsubmit="return checkForm()">
			<div class="data_form" >
					<table align="center">
					<div style="text-align: center;color: red;">${msg}</div>   
						<tr>
							...
							<%-- <select onchange="selectFunction()" id="dormBuildId" name="dormbuildname" style="width: 90px;"> 
								...
								<input type="text" name="dormbuildname" value="${sessionScope.t_dormbuild.dormBuildName}" readonly="readonly"> 
							</td> 
						</tr>
						<tr>
							...
							<input type="number" id="dormNumber" placeholder="请输入宿舍号" name="dormname" value="${sessionScope.currentUser.dormName }" readonly="readonly"    style="margin-top:5px;height:30px;" /> 
							</td>
						</tr>
						<tr>
							<td><font color="red">*</font>宿舍电话：</td>
							<td><input type="number" id="repairtel" name="repairtel" value="${sessionScope.currentUser.tel}" readonly="readonly"   style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
