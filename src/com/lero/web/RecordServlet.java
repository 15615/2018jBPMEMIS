...
import com.bwlk.mapper.DormBuildDao;
import com.bwlk.mapper.RecordDao;
import com.bwlk.mapper.StudentDao;
import com.bwlk.pojo.DormManager;
import com.bwlk.pojo.Record;
...
public class RecordServlet extends HttpServlet {
	...
	/*
	 * else { if("admin".equals((String)currentUserType)) {
	 * if(StringUtil.isNotEmpty(s_studentText)) { if("name".equals(searchType)) {
	 * record.setStudentName(s_studentText); } else if("number".equals(searchType))
	 * { record.setStudentNumber(s_studentText); } else
	 * if("dorm".equals(searchType)) { record.setDormName(s_studentText); }
	 * session.setAttribute("s_studentText", s_studentText);
	 * session.setAttribute("searchType", searchType); }
	 * if(StringUtil.isNotEmpty(dormBuildId)) {
	 * record.setDormBuildId(Integer.parseInt(dormBuildId));
	 ...
	 * Object o1 = session.getAttribute("s_studentText"); Object o2 =
	 * session.getAttribute("searchType"); Object o3 =
	 * session.getAttribute("buildToSelect"); if(o1!=null) {
	 * if("name".equals((String)o2)) { record.setStudentName((String)o1); } else
	 * if("number".equals((String)o2)) { record.setStudentNumber((String)o1); } else
	 * if("dorm".equals((String)o2)) { record.setDormName((String)o1); } } if(o3 !=
	 * null) { record.setDormBuildId(Integer.parseInt((String)o3)); } } } else
	 ...
	 * session.setAttribute("s_studentText", s_studentText);
	 * session.setAttribute("searchType", searchType); }
	 * if(StringUtil.isEmpty(s_studentText)) { Object o1 =
	 * session.getAttribute("s_studentText"); Object o2 =
	 * session.getAttribute("searchType"); if(o1!=null) {
	 * if("name".equals((String)o2)) { record.setStudentName((String)o1); } else
	 * if("number".equals((String)o2)) { record.setStudentNumber((String)o1); } else
	 * if("dorm".equals((String)o2)) { record.setDormName((String)o1); } } } } }
	 */
